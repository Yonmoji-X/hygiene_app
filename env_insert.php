...
// 4. データ登録SQL作成
$sql = "INSERT INTO m_env_table (env_q1, env_q2, env_q3, env_q4, env_q5_1, env_q5_2, env_q5_3, env_q6, env_q7, env_q8, env_text, env_name, indate, auth_id)
        VALUES (:env_q1, :env_q2, :env_q3, :env_q4, :env_q5_1, :env_q5_2, :env_q5_3, :env_q6, :env_q7, :env_q8, :env_text, :env_name, sysdate(),:auth_id)";
